...
if(isset($_POST['submit'])){
  ...
  $mobile=$_POST['mobile'];  
  $rera=$_POST['rera'];  
	$sql=mysqli_query($conn,"UPDATE `agent_details` SET `agent_name`='$name',`office_address`='$address',`mobile_no`='$mobile',`rera_no`='$rera'");
	if($sql==1){	
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
				<li class="nav-item"> <a class="nav-link" href="rentagreement.html">New Agreement</a></li>
