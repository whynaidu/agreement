...
if(isset($_POST['submit'])){
 ...
 $last_id = mysqli_insert_id($conn);					  
		header("location:stage1.php?id=".$no);
	}else{
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
				<li class="nav-item"> <a class="nav-link active" href="#">New Agreement</a></li>
                ...
                <div class="card-body">
                  <form class="forms-sample" method="post">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <select class="form-control" name="month" id="exampleSelectGender" required>
                          <option>11</option>
                          <option>22</option>
						              <option>36</option>
                        </select>
