...
if(isset($_POST['submit'])){
  ...
  ('$fid','$name','$age','$relation','$gender')");
	if($sql==1){	
    header("location:stage4.php?id=".$fid);
  	}else{
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <select class="form-control" id="exampleSelectrelation"name="relation">
                          <option>Child</option>
                ...
                <div class="card-body">
                  <div class="table-responsive pt-3">
                    ...
                    ?>
                      ...
                      <a class="btn btn-danger btn-rounded btn-icon" href="stage4.php?delid=<?php echo $arr['id']; ?>" onclick="return checkDelete()" class="btn btn-primary btn-rounded btn-icon">
