...
if(isset($_POST['submit'])){
  ...
  ('$id','$type','$address','$sector','$plotno','$cidco','$area','$chs','$node')");
	if($sql==1){	
    header("location:stage4.php?id=".$id);
  	}else{
...
?>
					...
					<a href="stage2.html"><button type="button" class="btn btn-primary  btn-lg" style="color: aliceblue"><i class="mdi mdi-chevron-left"></i>Previous</button></a>
